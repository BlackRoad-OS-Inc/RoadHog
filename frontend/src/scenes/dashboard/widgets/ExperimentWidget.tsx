    ...
    return (
        <div className="p-4 space-y-3 h-full overflow-auto">
            <div className="flex items-center gap-2">
                ...
                <span className={`text-xs font-medium px-2 py-0.5 rounded ${status.colorClass}`}>{status.label}</span>
            </div>

            {experiment.description && <p className="text-sm text-muted mb-0 line-clamp-2">{experiment.description}</p>}
