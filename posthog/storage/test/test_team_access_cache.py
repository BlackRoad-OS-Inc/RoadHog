...
class TestTokenAuthCacheNotConfigured(TestCase):
    """When FLAGS_REDIS_URL is None all invalidation is silently skipped."""

    def setUp(self):
        self.mock_redis = MagicMock(spec=redis_lib.Redis)
        self.cache = TokenAuthCache(redis_client=self.mock_redis)
