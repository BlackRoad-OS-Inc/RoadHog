...
class AlertSnapshot:
    ...
    recent_checks_breached: list[bool]
...
def evaluate_alert_check(
    ...
    """Implements the RFC state table: N-of-M consecutive trigger,
    PENDING_RESOLVE for symmetric resolution, and cooldown suppression.
    """
